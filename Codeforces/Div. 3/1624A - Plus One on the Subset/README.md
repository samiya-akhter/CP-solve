...
Polycarp got an array of integers a[1 … n] as a gift. Now he wants to perform a certain number of operations (possibly zero) so that all elements of the array become the same (that is, to become a_1=a_2=…=a_n).
...
What is the minimum number of operations it can take so that all elements of the array become equal to each other (that is, to become a_1=a_2=…=a_n)?
...
The second line of the description of each test case contains n integers a_1, a_2, …, a_n (1 ≤ a_i ≤ 10^9)  — elements of the array a.
