...
| Field | Value |
|---|---|
| **Contest** | [2072](https://codeforces.com/contest/2072) |
| **Problem** | [2072A — New World, New Me, New Array](https://codeforces.com/contest/2072/problem/A) |
| **Rating** | 800 |
...
In one operation, Akito chooses two integers i and x such that 1 ≤ i ≤ n and -p ≤ x ≤ p, and performs the assignment a_i = x.
...
> 🔗 [View on Codeforces](https://codeforces.com/contest/2072/problem/A)
