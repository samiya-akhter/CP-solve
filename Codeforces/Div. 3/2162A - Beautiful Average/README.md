...
Formally, for any indices l, r such that 1 ≤ l ≤ r ≤ n, define the average of the subarray a_l, a_l+1, …, a_r as the sum of elements divided by the number of elements or: avg(l,r) = 1/r-l+1 Σ_i=l^r a_iOutput the maximum value ofavg(l,r)over all choices ofl, r.
