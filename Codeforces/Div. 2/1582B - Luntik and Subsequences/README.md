...
| Field | Value |
|---|---|
| **Contest** | [1582](https://codeforces.com/contest/1582) |
| **Problem** | [1582B — Luntik and Subsequences](https://codeforces.com/contest/1582/problem/B) |
| **Rating** | 900 |
...
Luntik came out for a morning stroll and found an array a of length n. He calculated the sum s of the elements of the array (s= Σ_i=1^n a_i). Luntik calls a subsequence of the array a *nearly full* if the sum of the numbers in that subsequence is equal to s-1.
