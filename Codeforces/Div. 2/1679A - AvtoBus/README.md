...
| Field | Value |
|---|---|
| **Contest** | [1679](https://codeforces.com/contest/1679) |
| **Problem** | [1679A — AvtoBus](https://codeforces.com/contest/1679/problem/A) |
| **Rating** | 900 |
...
The first line contains an integer t (1 ≤ t ≤ 1 000) — the number of test cases. The following lines contain description of test cases.
