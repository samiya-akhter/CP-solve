...
| Field | Value |
|---|---|
| **Contest** | [1794](https://codeforces.com/contest/1794) |
| **Problem** | [1794B — Not Dividing](https://codeforces.com/contest/1794/problem/B) |
| **Rating** | 900 |
...
You are given an array of n positive integers a_1, a_2, …, a_n. In one operation, you can choose any number of the array and add 1 to it. 

Make at most 2n operations so that the array satisfies the following property: a_i+1 is **not** divisible by a_i, for each i = 1, 2, …, n-1. 
...
The second line of each test case contains n integers a_1,a_2,…,a_n (1≤ a_i≤ 10^9) — the given array.
