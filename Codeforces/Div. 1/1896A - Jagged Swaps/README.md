...
| Field | Value |
|---|---|
| **Contest** | [1896](https://codeforces.com/contest/1896) |
| **Problem** | [1896A — Jagged Swaps](https://codeforces.com/contest/1896/problem/A) |
| **Rating** | 800 |
| **Tags** | sortings |
| **Verdict** | ✅ Accepted |
...
You are given a permutation^dagger a of size n. You can do the following operation 
 ...
 - Select an index i from 2 to n - 1 such that a_i - 1 < a_i and a_i > a_i+1. Swap a_i and a_i+1.
...
> 🔗 [View on Codeforces](https://codeforces.com/contest/1896/problem/A)
